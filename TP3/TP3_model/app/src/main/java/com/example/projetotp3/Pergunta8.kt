 ...
 * Use the [pagina8.newInstance] factory method to
 * create an instance of this fragment.
 */
class pagina8 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.pergunta8, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button?.setOnClickListener {
            ...
            val agrRec = requireArguments().getInt("agr7")

            val ultimo = (list_agr.last() + agrRec)
            println(ultimo)

            findNavController().navigate(R.id.action_pagina8_to_pagina9, Bundle().apply {
                putInt("agr8",ultimo)
            })
