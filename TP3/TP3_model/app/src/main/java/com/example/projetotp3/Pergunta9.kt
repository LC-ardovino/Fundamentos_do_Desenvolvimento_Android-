...
class pagina9 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.pergunta9, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btn5 = view.findViewById<Button>(R.id.perg5)
        ...
        button?.setOnClickListener {
            ...
            val agrRec = requireArguments().getInt("agr8")

            val ultimo = (list_agr.last() + agrRec)
            println(ultimo)

            findNavController().navigate(R.id.action_pagina9_to_paginaResultado, Bundle().apply {
                putInt("resultado",ultimo)
            })
