...
class pagina3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.pergunta3, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button?.setOnClickListener {
            ...
            val agrRec = requireArguments().getInt("agr2")

            val ultimo = (list_agr.last() + agrRec)
            println(ultimo)

            findNavController().navigate(R.id.action_pagina3_to_pagina4, Bundle().apply {
                putInt("agr3",ultimo)
            })
